...
class _SceneSchedulePageState extends State<SceneSchedulePage>
    ...
    return Dismissible(
      ...
      confirmDismiss: (direction) async {
        if (direction == DismissDirection.endToStart) {
          ...
          showNoteEditor(context, scenes, _selectedIndex, _selectedIndex, index);
          return false;
        }
        return null;
      },
  ...
  void showNoteEditor(BuildContext context, List<SceneSchedule>scenes, int index, [int? selectedIndex, int? shotIndex]) async {
